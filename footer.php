        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode( '[contact-form-7 id="164" title="Форма вопрос"]'); ?>
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                <img src="<? echo bloginfo('template_url'); ?>/assets/img/icons/svg/phone.svg" alt="телефон" class="footer__contacts-logo">
                            ...
                            <div class="footer__contacts-item">
                                <img src="<? echo bloginfo('template_url'); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
